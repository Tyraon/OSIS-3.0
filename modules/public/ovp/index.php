...
<head>
    ...
    <style>
		...
		#control{opacity:0; margin-top:-50px; background:rgba(40,40,40,0.7); border-radius:5px; height:30px; padding:5px;  transition: all 0.5s ease-in-out; z-Index:105; position:absolute; width:90%; left:5%;}
...
opacity:0.5}
    ...
    <title>OVP @ <?php echo $site_title;?></title>

</head>
<body style="background:#000;">
<center>
<video id="vplayer" poster="video-icon-19.png" width="100%" height="100%" style="z-Index:101;">
<source id="source" src="../../../data/desktop/<?php echo $_SESSION['username'];?>/<?php echo @$_GET['f'];?>" type="video/mp4" />
</video>
<div id="control">
...
<button id="open" title="Video &ouml;ffnen (URL)">'</button>
</td></tr></table>
</div>
</center>
</body>
